...
/* 蓝牙配置参数 */
#define SYS_PARAM_BLE_DEV_NAME						"TEO_WC_X" //设备名字
...
/* IOT配置参数 */
#define SYS_PARAM_IOT_MODE							0			//0：周期模式，1：触发模式
#define SYS_PARAM_IOT_SAMPLE_PERIOD					5 			//周期模式下的采样频率，单位s
#define SYS_PARAM_IOT_TRIGGER_PERIOD				2 			//触发模式下持续触发时的数据推送频率，单位s
#define SYS_PARAM_IOT_ACCEL_SLOPE_THRESHOLD			100 		//触发模式下的加速度变化的斜率阈值
#define SYS_PARAM_IOT_CONSECUTIVE_DATA_POINTS		2 			//触发模式下连续数据点
#define IOT_PROTOCOL_WITH_ANGLE						0			//0：协议中不带角度数据，1：协议中带角度数据
